...
SRCC = 	str/ft_strindex.c			str/ft_strrindex.c		io/get_next_line.c		\
		...
		edit/lst1/ft_lstnew.c		lst1/ft_lstlast.c		lst1/ft_lstdel.c		\
		lst1/ft_lstiter.c			edit/lst1/ft_lstmap.c	lst1/ft_lstadd.c		\
		lst1/ft_lstaddlast.c		lst1/ft_lstisempty.c	lst1/ft_lstat.c			\
		edit/lst1/ft_lstdelone.c	lst1/ft_lstlen.c		mem/ft_realloc.c		\
		lst1/ft_lstislast.c			lst1/ft_lstinser.c		lst1/ft_lstrplc.c		\
		edit/lst1/ft_lstfind.c		lst1/ft_lstisn.c		lst1/ft_lstdellink.c	\
		...
		edit/lst2/ft_lnew.c			lst2/ft_lswap.c			io/get_all.c			\
